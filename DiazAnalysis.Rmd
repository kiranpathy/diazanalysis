...
freq_ff_22_tot <- nrow(filter(diaz_ff_22, !is.na(launch_speed)))
freq_ff_22_hardhit <- nrow(filter(diaz_ff_22, hardhit == 1))
...
freq_sl_22_tot <- nrow(filter(diaz_sl_22, !is.na(launch_speed)))
freq_sl_22_hardhit <- nrow(filter(diaz_sl_22, hardhit == 1))
...
freq_ff_24_tot <- nrow(filter(diaz_ff_24, !is.na(launch_speed)))
freq_ff_24_hardhit <- nrow(filter(diaz_ff_24, hardhit == 1))
...
freq_sl_24_tot <- nrow(filter(diaz_sl_24, !is.na(launch_speed)))
freq_sl_24_hardhit <- nrow(filter(diaz_sl_24, hardhit == 1))
...
freq_ff_25_tot <- nrow(filter(diaz_ff_25, !is.na(launch_speed)))
freq_ff_25_hardhit <- nrow(filter(diaz_ff_25, hardhit == 1))
...
freq_sl_25_tot <- nrow(filter(diaz_sl_25, !is.na(launch_speed)))
freq_sl_25_hardhit <- nrow(filter(diaz_sl_25, hardhit == 1))
...
**PERCENTAGES ARE OFF FOR THE PLOTS - NEED TO UPDATE!**
